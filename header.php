        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?section=dean#dean">دفتر رئیس دانشکده</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?section=education#education">دفتر آموزش </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?section=graduate#graduate">دفتر تحصیلات تکمیلی </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?section=faculty#faculty">اتاق اساتید </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?section=labs#labs">آزمایشگاه ها</a>
                    </li>
                    <li class="nav-item">
